...
if ch==1:
    ...
    if ch7 == 1:
        ...
        print("Enter the med_id ")
        med_id=int(input())
        print("Enter the new details(price,qty,d_number,med_id,med_description)in the specified order")
        price=int(input())
        qty=int(input())
        d_number=int(input())
        med_id=int(input())
        med_description=input()
        updateRecord("Medicine",price,qty,d_number,med_id,med_description)
    else:
        print("Wrong Choice")
elif ch==4:
    print("Nurse Section!!")
    ...
    if ch7 == 1:
        ...
        print("Enter the t_id ")
        t_id=int(input())
        print("Enter the new details(t_id,p_id,is_treated)in the specified order")
        t_id=int(input())
        p_id=int(input())
        is_treated=input()
        updateRecord("Treatment",t_id,p_id,is_treated)
    else:
        print("Wrong Choice")
elif ch==7:
